...
public interface Document extends Node {
	 ...
	 * Otherwise, this simply generates an empty <code>DocumentFragment</code>.</dd>
	 * <dt>DOCUMENT_NODE</dt>
	 ...
	 *                specified in the <code>Document.xmlVersion</code>
	 *                attribute. This may happen when importing an XML 1.1 [<a
	 *                href='http://www.w3.org/TR/2004/REC-xml11-20040204/'>XML
	 ...
	 * and "1.1" (respectively) to determine if an implementation supports [<a
	 ...
	 * assigned. The descendants of the source element are recursively adopted.</dd>
	 * <dt>ENTITY_NODE</dt>
	 * <dd>
	 ...
	 * into provides a definition for this entity name, its value is assigned.</dd>
	 * <dt>NOTATION_NODE</dt>
	 ...
	 * and in the end the event { <code>http://www.w3.org/2001/xml-events</code>, <code>DOMElementNameChanged</code> or {
