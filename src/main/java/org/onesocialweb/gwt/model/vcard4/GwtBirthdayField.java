...
import org.onesocialweb.gwt.model.AtomHelper;
import org.onesocialweb.model.acl.AclRule;
import org.onesocialweb.model.vcard4.BirthdayField;

public class GwtBirthdayField extends BirthdayField {
	...
	protected Date parseDate(String dateString) {
		return AtomHelper.parseDate(dateString);
	}

	protected String formatDate(Date date) {
		return AtomHelper.formatDate(date);
	}
}
