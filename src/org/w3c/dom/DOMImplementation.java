...
public interface DOMImplementation {
	 ...
	 *                href='http://www.w3.org/TR/2004/REC-xml-20040204'>XML
	 *                1.0</a>]. <br>
	 ...
	 * 2 HTML</a>] . On the other hand, setting the <code>DocumentType</code>
	 * after the document was created makes this very unlikely to happen.
	 * Alternatively, specialized <code>Document</code> creation methods, such
	 * as <code>createHTMLDocument</code> [<a
	 * href='http://www.w3.org/TR/2003/REC-DOM-Level-2-HTML-20030109'>DOM Level
	 * 2 HTML</a>] , can be used to obtain specific types of
